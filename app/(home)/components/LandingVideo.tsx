...
const LandingVideo = () => {
    return (
        <>
            <video className="w-screen brightness-50 h-[65dvh] min-h-[36rem] md:h-[70dvh] max-h-[40rem] lg:max-h-none lg:min-h-[45rem] object-cover object-center" autoPlay muted loop poster="/poster.webp" src={videoUrl}></video>
