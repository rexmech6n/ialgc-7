...
const LandingVideo = () => {
    return (
        <>
            <video className="w-screen brightness-50 h-[65dvh] md:h-[70dvh] min-h-[36rem] max-h-[40rem] object-cover object-center" autoPlay muted loop poster="/poster.webp" src={videoUrl}></video>
