...
const NavbarLink = ({children, path, icon}: NavbarLinkProps) => {
    ...
    return (
        <Link href={path} className={`flex items-center rounded-full transition-colors duration-200 text-[#6B1710] ease-linear py-1.5 px-1.5 mx-1.5 sm:py-2 sm:px-3 sm:mx-2 text-base ${getConditionalStyles("font-semibold bg-[#DE55557F] [&>div>svg]:fill-[#6B1710] text-xs sm:text-base delay-200", active)}`}>
